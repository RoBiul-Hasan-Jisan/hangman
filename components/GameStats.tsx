  ...
  return (
    ...
    >
      ...
      <div
        ref={totalRef}
        data-stat-card
        className="glass group cursor-pointer relative overflow-hidden border-2 border-blue-500/30 p-6 hover:border-blue-500/60"
      >
        ...
        {/* Hover glow effect */}
        <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-blue-500 to-transparent opacity-0 group-hover:opacity-100"></div>
      </div>
      ...
      <div
        ref={wonRef}
        data-stat-card
        className="glass group cursor-pointer relative overflow-hidden border-2 border-emerald-500/30 p-6 hover:border-emerald-500/60"
      >
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-emerald-500 to-transparent opacity-0 group-hover:opacity-100"></div>
      </div>
      ...
      <div
        ref={winRateRef}
        data-stat-card
        className="glass group cursor-pointer relative overflow-hidden border-2 border-purple-500/30 p-6 hover:border-purple-500/60"
      >
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-purple-500 to-transparent opacity-0 group-hover:opacity-100"></div>
      </div>
    </div>
  );
}
